  ...
  return (
    <>
     <div className="h-full relative">
			<div className="absolute inset-0 object-cover bg-center bg-cover blur-md opacity-30" style={{backgroundImage: `url(${currentSong.image})`}} />
			...
			<div className="absolute left-8 bottom-36 flex items-center gap-x-5">
				<img src={currentSong.image} alt="" className="w-24 h-24 object-cover"/>
				<div className="self-end">
					<h3 className="text-3xl font-bold">{currentSong.title}</h3>
					<p className="text-sm font-medium opacity-50">{currentSong.description}</p>
				</div>
			</div>
